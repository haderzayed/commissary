...
<head>
    ...
    <title>@yield('title', 'مندبين')</title>    <link rel="icon" type="image/x-icon" href="{{asset('back/assets/img/favicon.ico')}}"/>
...
<script src="{{ asset('back/plugins/table/datatable/button-ext/dataTables.buttons.min.js')}}"></script>
<script src="{{ asset('back/plugins/table/datatable/button-ext/jszip.min.js')}}"></script>
<script src="{{ asset('back/plugins/table/datatable/button-ext/buttons.html5.min.js')}}"></script>

<script src="{{ asset('back/plugins/table/datatable/button-ext/buttons.print.min.js')}}"></script>

                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form"
                                              action="{{route('users.update',$allusers -> id)}}"
                                              method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="representative_city_id" id="govers"  style='display:block !important;' class="form-control govers">
                                                                <option value="{{$allusers->representative_city_id}}">{{$allusers->representative_city_id}}</option>
                                                                {{--                                                                <option value="">اختر المدينة</option>--}}
                                                                {{--                                            @if(!empty($subjectitems) && count($subjectitems) > 0)--}}
                                                                {{--                                                @foreach($subjectitems as $subj)--}}
                                                                {{--                                                    @if($subj->translation_lang === $lang -> abbr)--}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <select name="role_id" class="form-control">
                                                                @if(count($roles) > 0)
                                                                    <option value=""> {{$allusers->roles->name}}</option>

                                                                    @foreach($roles as $role)
                                                                        <option value="{{$role->id}}" {{session()->exists('data') && $role->id == session()->get('data')['role_id'] ? 'selected' : 'لا يوجد صلاحية'}}>{{$role->name}}</option>
                                                                    @endforeach
                                                                @else

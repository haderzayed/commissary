                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">الصور المتحركه</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">جميع الصور المتحركه</h3>
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-head-fixed table-striped">
                                    ...
                                    @forelse($sliders  as $item)
                                        <tr id="item_{{$item->id}}">
                                            <td>{{ $item->title }}</td>
                                            <td><img style="width: 50px; height: 50px;" src="{{asset($item->image)}}"></td>
                                            <td>
...
@section('js')
    <script>
        ...
        function edit_item(id) {
            $.ajax({
                type: "GET",
                url: `{{ URL::to('admin/sliders') }}/${id}/edit`,
                success: function (response) {
                    jQuery('.modal-dialog').html(response);
                }
            });
        ...
        function delete_item(id){
            Swal({
                ...
                if (result.value) {
                    $.ajax({
                        type:'POST',
                        url: `{{ url('admin/sliders') }}/${id}/destroy`,

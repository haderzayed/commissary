                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">الختمات</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">جميع الختمات</h3>
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-head-fixed table-striped">
                                    ...
                                    @empty
                                        <tr id="not_element">
                                            <td colspan="6">لا يوجد ختمات حتى الان</td>
                                        </tr>
                                    @endforelse
...
@section('js')
    <script>
        ...
        function edit_item(id) {
            $.ajax({
                type: "GET",
                url: `{{ URL::to('admin/readings') }}/${id}/edit`,
                success: function (response) {
                    jQuery('.modal-dialog').html(response);
                }
            });
        ...
        function delete_item(id){
            Swal({
                ...
                if (result.value) {
                    $.ajax({
                        type:'POST',
                        url: `{{ url('admin/readings') }}/${id}/destroy`,

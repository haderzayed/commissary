                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-content collapse show">
                                            <div class="card-body">
                                                <form class="form" action="{{route('city.update',$city->id)}}"
                                                      method="POST"
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <h4 class="form-section"><i class="ft-home"></i>  تعديل مدينة {{$city->name_city}} </h4>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="{{$city->name_city}}"
                                                                           class="form-control"
                                                                           placeholder="الاسم"
                                                                           name="name_city">
                                                                    @error('name_city')
                                                                    ...
                                                                    <select id="sel_count"
                                                                        ...
                                                                        @if(count($countries) > 0)
                                                                            ...
                                                                            @foreach($countries as $corp)
                                                                                <option value="{{$corp->id}}" @if($corp->id==$city->Country_id) selected @endif> {{$corp->name_coun}} </option>
                                                                            @endforeach
                                                                        @else
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="terr"
                                                                            class="form-control"
                                                                            name="Territory_id">
                                                                        <option value="{{$city->Territory_id}}">{{$city -> Territory->name_terr}}
                                                                        </option>
                                                                    </select>
                                                                    @error("Territory_id")
                                                                    <span class="text-danger">  {{ $message }}</span>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="gover"
                                                                            class="form-control"
                                                                            name="Governorate_id">
                                                                        <option value="{{$city->Governorate_id}}">{{$city->Governorate->name_gover}}
                                                                        </option>
                                                                    </select>

        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">  مندوبين لوحه التحكم </h3>
...
{{--                                    @if(in_array('all_permissions' ,\Illuminate\Support\Facades\Auth::user()->role->permissions)) == true)in_array('managment_store' ,\Illuminate\Support\Facades\Auth::user()->role->permissions))--}}
                                    <a href="{{route('representative.create')}}">اضافة مندوب</a>

{{--                                    @endif--}}
                                </li>
                                <li class="breadcrumb-item active">   مندوب
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع مندوبين </h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('representative.edit',$user -> id)}}"
